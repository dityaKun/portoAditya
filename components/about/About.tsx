      ...
      <div className="mx-auto flex w-[90%] flex-col items-start justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-full flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="lg:mg-16 mb-10 flex w-full flex-col gap-4 text-[18px] font-medium leading-relaxed tracking-wide md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:max-w-[90%] lg:text-base">
            <AnimateParagraph
              paragraph= "Perkenalkan Nama Saya Adalah Aditya Ferdian Ramdani Saya Adalah Mahasiswa di Universitas Brawijaya "
              delay={1.5}
            />
            <AnimateParagraph
              paragraph="Saya lahir di Surabaya 16 Oktober 2004 dan Tinggal di Kota Krian,Kabupaten Sidoarjo"
              delay={1.8}
            />
            <AnimateHeading title="Track Pendidikan" delay={0.5} />
            <AnimateParagraph
              paragraph="Saya menempuh Pendidikan di TK 'Tunas Brawijaya', SD 'SDN Sidogolong 2', SMP 'SMPN 3 KRIAN' ,SMA 'WACHID HASYIM 2 TAMAN' "
              delay={2}
            />
            <AnimateHeading title="Hobby" delay={0.5} />
            <AnimateParagraph
              paragraph="Saya mempunyai beberapa Hobby Diantara nya adalah ,bermain alat musik,mencicipi coffe dari berbagai daerah,kuliner,membuat desain seperti (poster,sticker,jaket,dan beberapa barang lainya),saya juga mempunyai hobby traveling ketika saya memiliki waktu senggang"
              delay={2.5}
            />
          </div>
          ...
          <div className="mb-24 flex w-full flex-col gap-4 leading-relaxed tracking-wide sm:mb-32 md:mb-40 md:gap-6 md:leading-relaxed lg:mb-16 lg:max-w-[90%]">
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimateBody
                text="Dalam mengerjakan sebuah pekerjaan atau tugas saya biasanya menggunakan beberapa tools diantarnya 'git,node.js,vscode,vercel,photoshop'"
                delay={1}
                className="text-sm"
              />
            </div>
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimateBody
                text="figma,canva,photshop,tailwind,css,java."
                delay={1.5}
                className="text-sm"
              />
            </div>
